...
const persiaSignAccessories = [
  ...
  accessory(brands.persiaSign, {
    title: "پک ۲ عددی اکتان بوستر پرشیا ساین Up to 5",
    latinName: "Persia Sign Up to 5 Octane Booster 2-Pack",
    slug: "up-to-5-octane-booster-450ml-pack-2",
    sku: "PRS-OCT-5P-450-P2",
    productType: "پک اقتصادی افزاینده اکتان و تمیزکننده سیستم سوخت",
    volumeLabel: "حجم ۴۵۰ میلی‌لیتر",
    packagingSizeLit: 0.9,
    image: "/products/persia-sign/up-to-5-450ml-pack-2.webp",
    summary:
      "پک ۲ عددی Up to 5 پرشیا ساین برای خرید اقتصادی، مصرف دوره‌ای یا استفاده هم‌زمان روی چند خودرو آماده شده و همان فرمول افزاینده اکتان تا پنج واحد و کمک به پاکیزگی انژکتور را در دو بطری ۴۵۰ میلی‌لیتری ارائه می‌کند.",
    source:
      "https://www.tasnimnews.ir/fa/news/1405/04/22/3646586/پرشیا-خودرو-از-نسل-جدید-مکمل-سوخت-persia-sign-رونمایی-کرد",
    specs: {
      "تعداد در بسته": "۲ عدد",
      "حجم هر عدد": "۴۵۰ میلی‌لیتر",
      "حجم کل": "۹۰۰ میلی‌لیتر",
      "حجم سوخت قابل تیمار": "هر بطری تا حدود ۵۰ لیتر",
      ترکیبات: "فاقد سرب، فروسن و MMT طبق اعلام عرضه‌کننده",
      "سازگاری اعلام‌شده": "موتورهای تنفس طبیعی، توربو و تزریق مستقیم",
    },
    tags: ["پک اقتصادی", "اکتان بوستر", "مکمل بنزین", "پرشیا ساین"],
  }),
  accessory(brands.persiaSign, {
    title: "پک ۳ عددی اکتان بوستر پرشیا ساین Up to 5",
    latinName: "Persia Sign Up to 5 Octane Booster 3-Pack",
    slug: "up-to-5-octane-booster-450ml-pack-3",
    sku: "PRS-OCT-5P-450-P3",
    productType: "پک اقتصادی افزاینده اکتان و تمیزکننده سیستم سوخت",
    volumeLabel: "حجم ۴۵۰ میلی‌لیتر",
    packagingSizeLit: 1.35,
    image: "/products/persia-sign/up-to-5-450ml-pack-3.webp",
    summary:
      "پک ۳ عددی Up to 5 پرشیا ساین برای مشتریانی مناسب است که مکمل سوخت را به‌صورت منظم استفاده می‌کنند و می‌خواهند سه بطری ۴۵۰ میلی‌لیتری افزاینده اکتان و کمک‌کننده پاکیزگی مسیر سوخت را به‌صرفه‌تر تهیه کنند.",
    source:
      "https://www.tasnimnews.ir/fa/news/1405/04/22/3646586/پرشیا-خودرو-از-نسل-جدید-مکمل-سوخت-persia-sign-رونمایی-کرد",
    specs: {
      "تعداد در بسته": "۳ عدد",
  ...
  accessory(brands.persiaSign, {
    title: "پک ۴ عددی اکتان بوستر پرشیا ساین Up to 5",
    latinName: "Persia Sign Up to 5 Octane Booster 4-Pack",
    slug: "up-to-5-octane-booster-450ml-pack-4",
    sku: "PRS-OCT-5P-450-P4",
    productType: "پک اقتصادی افزاینده اکتان و تمیزکننده سیستم سوخت",
    volumeLabel: "حجم ۴۵۰ میلی‌لیتر",
    packagingSizeLit: 1.8,
    image: "/products/persia-sign/up-to-5-450ml-pack-4.webp",
    summary:
      "پک ۴ عددی Up to 5 پرشیا ساین برای خرید اقتصادی‌تر و مصرف چندمرحله‌ای طراحی شده و چهار بطری ۴۵۰ میلی‌لیتری افزاینده اکتان را برای کاهش ناک، بهبود کیفیت احتراق و کمک به تمیزی سیستم سوخت در اختیار مشتری می‌گذارد.",
    source:
      "https://www.tasnimnews.ir/fa/news/1405/04/22/3646586/پرشیا-خودرو-از-نسل-جدید-مکمل-سوخت-persia-sign-رونمایی-کرد",
    specs: {
      "تعداد در بسته": "۴ عدد",
