...
- 🚚 استعلام سمت‌سرور هزینهٔ پست و تیپاکس، انتخاب روش در تسویه و رهگیری مرسوله از پنل مدیریت
...
- راه‌اندازی ارسال، متغیرهای Amadast و چک‌لیست انتشار در [`docs/shipping.md`](docs/shipping.md) مستند شده است.
