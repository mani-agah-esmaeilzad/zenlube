export default function SupportPage() {
  return (
    <div className="container-zen space-y-8 py-6 md:py-8">
      <section>
        <p className="text-sm font-bold text-primary-accent-strong">همراه شما در خرید</p>
        <h1 className="t-h1 mt-2">پشتیبانی Oilbar</h1>
      ...
      <section className="rounded-2xl border border-border bg-surface-secondary p-6 text-sm leading-8 text-text-muted">
        <p>
